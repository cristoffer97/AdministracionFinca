...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-05-2023 a las 17:54:28
...
(4, 1202, 0, 'Pruebafsdafas', 'asfasfasfasf', '2023-05-09');
...
(1, 1, 2, 0, 'Cubo', '2023-05-09', 0, 1),
(2, 2, 4, 1, 'Cubo', '2023-05-09', 0, 1),
(3, 3, 2, 1, NULL, '2023-05-11', 0, 1),
(4, 2, 5, 1, 'PRUEBATRIGGERBORRAD', '2023-05-09', 0, 1);

--
-- Disparadores `registro`
--
DELIMITER $$
CREATE TRIGGER `Actualizar` BEFORE UPDATE ON `registro` FOR EACH ROW BEGIN  
INSERT INTO `registro_tarea_cuadrilla`(`ID_Cuadrilla`, `ID_Tarea`, `ID_Fruta`, `TipoRecogida`, `CantidadPaleps`, `Nº_Pase`) VALUES (old.ID_Cuadrilla , new.ID_Tarea , new.ID_Fruta ,new.TipoRecogida,new.CantidadPaleps, new.Nº_Pase);  
END
$$
DELIMITER ;
DELIMITER $$
...
(14, 10, '', 'Cristo', 'Alcalde', '2023-03-15', '2023-05-13'),
(15, 1, '', 'federico', 'mata', '2023-03-16', '2023-03-16'),
(16, 142, '12345679G', 'GABRIEL', 'NAVARRO PAREJO', '2023-03-24', '2023-03-24'),
(17, 10, 'Javie', 'GABRIELinColorado', 'NAVARRO PAREJO', '2023-03-24', '2023-05-13'),
...
(24, 6700, '12348567f', 'Marcos', 'Feval', '2023-05-04', '2023-05-04');
...
(5, 1, 2, 1, 'Cubo', '2023-05-09', 0, 1),
(6, 1, 4, 0, 'Cubo', '2023-05-09', 0, 1),
(7, 1, 2, 0, 'Cubo', '2023-05-09', 0, 1),
(8, 2, 4, 1, 'Cubo', '2023-05-09', 0, 1),
(14, 3, 2, 1, NULL, '2023-05-09', 0, 1),
(15, 3, 2, 1, NULL, '2023-05-11', 0, 1),
(16, 2, 5, 1, 'PRUEBATRIGGERBORRAD', '2023-05-09', 0, 1);
...
(1202, 'Alcalde', 'Mata', '12345678G', 123456789, 1, 0, 5),
...
(6700, 'PABLITO', 'Feval', '12348567f', 159753202, 1, 1, 1),
