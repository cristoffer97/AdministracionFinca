 ...
 * @author Cristoffer
 */
public class GestionTractores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Titulo.setText("GESTION DE TRACTORES");
    ...
    /**
     * Con este metodo damos de alta a un tractor
     *
     * @param evt
     */
    private void btnoInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnoInsertarActionPerformed
        ...
        if (consulta.InsertarTractor(codtrabaj, matricula, herramienta) == true) {
    ...
    /**
     * Con este metodo modificamos al tractor
     *
     * @param evt
     */
    private void btnoModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnoModificarActionPerformed
        ...
        if (consulta.actualizarTractor(codtrabaj, matricula, herramienta) == true) {
            JOptionPane.showMessageDialog(null, "Se ha actualizado el tractor");
            actualizar_Tabla();
        } else {
            JOptionPane.showMessageDialog(null, "No se podido actualizar");

        }

    }//GEN-LAST:event_btnoModificarActionPerformed
    /**
     * Con este metodo borramos el tractor
     *
     * @param evt
     */
    private void btnoBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnoBajaActionPerformed
        ...
        if (consulta.BorrarTractor(Cod_Tractor) == true) {
            JOptionPane.showMessageDialog(null, "Se ha borrado el tractor");
            actualizar_Tabla();
        } else {
            JOptionPane.showMessageDialog(null, "No se ha podido borrar el tractor");
        }
    ...
    /**
     * Con este metodo realizamos la busqueda del Tractor solicitado
     *
     * @param evt
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionTractores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionTractores().setVisible(true);
            }
        });
    }
    ...
    /**
     * Llenamos el combo box con las herramientas que obtenemos
     */
